...
static LPCSTR FullNames[NLANGS][NLANGS]=	{/* Es         En          It          Fr       */
                                      /*Es*/{"Español" , "Inglés" , "Italiano", "Francés"  },
                                      /*En*/{"Spanish" , "English", "Italian" , "French"   },
                                      /*It*/{"Spagnolo", "Inglese", "Italiano", "Francese" },
                                      /*Fr*/{"Espagnol", "Anglais", "Italien" , "Français" },
                                          };
