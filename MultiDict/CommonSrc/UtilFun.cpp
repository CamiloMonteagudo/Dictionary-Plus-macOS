...
void DelAccent(CStringA &s)
	{
  s.Replace((char)255/*'á'*/,'a');
  s.Replace((char)233/*'é'*/,'e');
  s.Replace((char)237/*'í'*/,'i');
  s.Replace((char)243/*'ó'*/,'o');
  s.Replace((char)250/*'ú'*/,'u');
  s.Replace((char)193/*'Á'*/,'A');
  s.Replace((char)201/*'É'*/,'E');
  s.Replace((char)205/*'Í'*/,'I');
  s.Replace((char)211/*'Ó'*/,'O');
  s.Replace((char)218/*'Ú'*/,'U');
  s.Replace((char)226/*'â'*/,'a');
  s.Replace((char)234/*'ê'*/,'e');
  s.Replace((char)238/*'î'*/,'i');
  s.Replace((char)244/*'ô'*/,'o');
  s.Replace((char)251/*'û'*/,'u');
  s.Replace((char)194/*'Â'*/,'A');
  s.Replace((char)202/*'Ê'*/,'E');
  s.Replace((char)206/*'Î'*/,'I');
  s.Replace((char)212/*'Ô'*/,'O');
  s.Replace((char)219/*'Ô'*/,'U');
  s.Replace((char)227/*'ã'*/,'a');
  s.Replace((char)245/*'õ'*/,'i');
  s.Replace((char)195/*'Ã'*/,'A');
  s.Replace((char)213/*'Õ'*/,'O');
  s.Replace((char)224/*'à'*/,'a');
  s.Replace((char)232/*'è'*/,'e');
  s.Replace((char)236/*'ì'*/,'i');
  s.Replace((char)242/*'ò'*/,'o');
  s.Replace((char)249/*'ù'*/,'u');
  s.Replace((char)192/*'À'*/,'A');
  s.Replace((char)200/*'È'*/,'E');
  s.Replace((char)204/*'Ì'*/,'I');
  s.Replace((char)210/*'Ò'*/,'O');
  s.Replace((char)249/*'Ù'*/,'U');
	}
